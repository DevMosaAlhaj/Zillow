        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<double>(type: "float", maxLength: 12, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Contract_RealEstate_RealEstatesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contract_RealEstatesId",
                table: "Contract",
                column: "RealEstatesId");

            migrationBuilder.CreateIndex(
                name: "IX_Image_RealEstateId",
                table: "Image",
                column: "RealEstateId");
